...
/*
 * This class contains the configuration parameters for the
 * specific OpenVoters implementation.
 */
public class OVConfig {
    ...
    private static final String CACHE_CONFIG_FILENAME = "infinispan.xml";
